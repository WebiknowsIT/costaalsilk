...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Password',
            'powered-by-description' => 'Powered by : Webiknows',
            'submit-btn'             => 'Sign In',
            'title'                  => 'Sign In',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Powered by : Webiknows',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Powered by <a href="https://webiknows.com" target="_blank">Webiknows</a>',
    ],
        ...
        'sellers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'order'          => ':order Order(s)',
                    'order-count'    => 'Order Count',
                    'order-pending'  => 'Seller have pending order',
                    'partial-action' => 'Some actions were not performed due restricted system constraints on :resource',
                    'phone'          => 'Contact Number',
                    'revenue'        => 'Revenue',
                    'status'         => 'Status',
                ...
                'create' => [
                    'contact-number'        => 'Contact Number',
                    'create-btn'            => 'Create Seller',
                    'create-success'        => 'Seller created successfully',
                    ...
                    'select-customer-group' => 'Select Seller Group',
                    'select-gender'         => 'Select Gender',
                ...
                'view' => [
                    ...
                    'delete'                      => 'Delete',
                    'email'                       => 'Email - :email',
                    'empty-description'           => 'Create New Addresses for Seller',
                    'empty-title'                 => 'Add Seller Address',
                    'gender'                      => 'Gender - :gender',
                    'group'                       => 'Group - :group_code',
                    'inactive'                    => 'Inactive',
                    'login-as-customer'           => 'Login as seller',
                    'note-created-success'        => 'Note Created Successfully',
                    'order-create-confirmation'   => 'Are you sure you want to create order for this seller?',
                    'phone'                       => 'Phone - :phone',
                    'set-as-default'              => 'Set as Default',
                    'suspended'                   => 'Suspended',
                    'title'                       => 'Seller View',
            ...
            'delete-failed'  => 'Seller Deleted Failed',
