<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.sellers.sellers.index.title')
    </x-slot>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-x-2.5">
            <!-- Export Modal -->
            <x-admin::datagrid.export src="{{ route('admin.sellers.sellers.index') }}" />

            <div class="flex items-center gap-x-2.5">
                <!-- Included seller create blade file -->
                @if (bouncer()->hasPermission('sellers.sellers.create'))
                    ...
                    <v-create-customer-form
                        ...
                        @customer-created="$refs.sellerDatagrid.get()"
                    ></v-create-customer-form>
                    ...
                    >
                        @lang('admin::app.sellers.sellers.index.create.create-btn')
                    </button>
                @endif
            </div>
        </div>
            ...
            <template v-else>
                <div class="row grid grid-cols-[2fr_1fr_1fr] grid-rows-1 items-center border-b px-4 py-2.5 dark:border-gray-800">
                    <div
                        ...
                        v-for="(columnGroup, index) in [['full_name', 'email', 'phone'], ['status', 'gender', 'group', 'seller_id'], ['revenue', 'order_count', 'address_count']]"
                    >
                        @if ($hasPermission)
                            <label
