...
class Core
{
     ...
     * Guest Seller Group
     *
     * @var \Webkul\Seller\Models\SellerGroup
     */
    protected $guestSellerGroup;
     ...
     * Return guest customer group.
     *
     * @return \Webkul\Seller\Contract\SellerGroup
     */
    public function getGuestSellerGroup()
    {
        if ($this->guestSellerGroup) {
            return $this->guestSellerGroup;
        }

        return $this->guestSellerGroup = $this->sellerGroupRepository->findOneByField('code', 'guest');
    }
